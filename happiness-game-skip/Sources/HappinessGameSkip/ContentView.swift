...
enum ContentTab: String, Hashable {
    case chara, anime, home, settings
}

struct ContentView: View {
    @AppStorage("tab") var tab = ContentTab.chara
    ...
    var body: some View {
        TabView(selection: $tab) {
            NavigationStack {
                HappinessCharaScreen()
            }
            .tabItem { Label("キャラ", systemImage: "person.fill") }
            .tag(ContentTab.chara)

            NavigationStack {
                HappinessAnimeScreen()
            }
            .tabItem { Label("アニメ", systemImage: "tv.fill") }
            .tag(ContentTab.anime)
